...
import sys
# For connection to onos controller
# sudo python mirror.py onos 
...
if '__main__' == __name__:
	...
	# h1, h7 , h9 , h11 are "external to the system"
	# h3 and h8 , h10,  12 are meant for suricata, for s1 and s5 
